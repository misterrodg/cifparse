...
class HeliProcedures:
    ...
    def get_heli_procedure_by_id(self, heli_procedure_id: str) -> HeliProcedure:
        result = None
    ...
    def _create_procedure_segments_table(self, db_cursor: Cursor) -> None:
        ...
        create_statement = f"CREATE TABLE {table_name} AS SELECT DISTINCT st, area, sec_code, fac_id, fac_region, fac_sub_code, procedure_id, route_type, transition_id FROM heli_procedure_points;"
        db_cursor.execute(create_statement)
        return
