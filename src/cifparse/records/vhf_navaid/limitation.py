...
class Limitation(Base):
    ...
    def to_dict(self) -> dict:
        ...
        this_dict = {
            ...
            "nlc": clean_value(self.nlc),
            "cai": clean_value(self.cai),
            "seq_no": clean_value(self.seq_no),
            "sector_1": clean_value(self.sector_1),
            "dist_desc_1": clean_value(self.dist_desc_1),
            "dist_limit_1": clean_value(self.dist_limit_1),
            "alt_desc_1": clean_value(self.alt_desc_1),
            "alt_limit_1": clean_value(self.alt_limit_1),
            "sector_2": clean_value(self.sector_2),
            "dist_desc_2": clean_value(self.dist_desc_2),
            "dist_limit_2": clean_value(self.dist_limit_2),
            "alt_desc_2": clean_value(self.alt_desc_2),
            "alt_limit_2": clean_value(self.alt_limit_2),
            "sector_3": clean_value(self.sector_3),
            "dist_desc_3": clean_value(self.dist_desc_3),
            "dist_limit_3": clean_value(self.dist_limit_3),
            "alt_desc_3": clean_value(self.alt_desc_3),
            "alt_limit_3": clean_value(self.alt_limit_3),
            "sector_4": clean_value(self.sector_4),
            "dist_desc_4": clean_value(self.dist_desc_4),
            "dist_limit_4": clean_value(self.dist_limit_4),
            "alt_desc_4": clean_value(self.alt_desc_4),
            "alt_limit_4": clean_value(self.alt_limit_4),
            "sector_5": clean_value(self.sector_5),
            "dist_desc_5": clean_value(self.dist_desc_5),
            "dist_limit_5": clean_value(self.dist_limit_5),
            "alt_desc_5": clean_value(self.alt_desc_5),
            "alt_limit_5": clean_value(self.alt_limit_5),
            "seq_ind": clean_value(self.seq_ind),
        }
