...
class Primary(Base):
    ...
    def to_dict(self) -> dict:
        ...
        this_dict = {
            "start_lat": clean_value(self.start_lat),
            "start_lon": clean_value(self.start_lon),
            "mora_1": clean_value(self.mora_1),
            "mora_2": clean_value(self.mora_2),
            "mora_3": clean_value(self.mora_3),
            "mora_4": clean_value(self.mora_4),
            "mora_5": clean_value(self.mora_5),
            "mora_6": clean_value(self.mora_6),
            "mora_7": clean_value(self.mora_7),
            "mora_8": clean_value(self.mora_8),
            "mora_9": clean_value(self.mora_9),
            "mora_10": clean_value(self.mora_10),
            "mora_11": clean_value(self.mora_11),
            "mora_12": clean_value(self.mora_12),
            "mora_13": clean_value(self.mora_13),
            "mora_14": clean_value(self.mora_14),
            "mora_15": clean_value(self.mora_15),
            "mora_16": clean_value(self.mora_16),
            "mora_17": clean_value(self.mora_17),
            "mora_18": clean_value(self.mora_18),
            "mora_19": clean_value(self.mora_19),
            "mora_20": clean_value(self.mora_20),
            "mora_21": clean_value(self.mora_21),
            "mora_22": clean_value(self.mora_22),
            "mora_23": clean_value(self.mora_23),
            "mora_24": clean_value(self.mora_24),
            "mora_25": clean_value(self.mora_25),
            "mora_26": clean_value(self.mora_26),
            "mora_27": clean_value(self.mora_27),
            "mora_28": clean_value(self.mora_28),
            "mora_29": clean_value(self.mora_29),
