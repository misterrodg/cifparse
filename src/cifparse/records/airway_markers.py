...
from .airway_marker.primary import Primary
from .airway_marker.continuation import Continuation
from .airway_marker.widths import w_pri, w_con

from sqlite3 import Cursor


class AirwayMarker(RecordBase):
    primary: Primary
...
class AirwayMarkers:
    records: list[AirwayMarker]

    def __init__(self, marker_lines: list[str]):
        self.records = []

        print("    Parsing Airway Markers")
    ...
    def to_db(self, db_cursor: Cursor) -> None:
        ...
        print("    Processing Airway Markers")
