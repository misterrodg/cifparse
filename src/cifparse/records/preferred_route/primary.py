...
class Primary(Base):
    ...
    def to_dict(self) -> dict:
        ...
        this_dict = {
            ...
            "int_point": clean_value(self.int_point),
            "int_region": clean_value(self.int_region),
            "int_sec_code": clean_value(self.int_sec_code),
            "int_sub_code": clean_value(self.int_sub_code),
            "term_point": clean_value(self.term_point),
            "term_region": clean_value(self.term_region),
            "term_sec_code": clean_value(self.term_sec_code),
            "term_sub_code": clean_value(self.term_sub_code),
            ...
            "aircraft_use": clean_value(self.aircraft_use),
            "direction": clean_value(self.direction),
