...
class Primary(Base):
    ...
    def __init__(self):
        super().__init__("heli_procedure_points")
    ...
    def from_line(self, line: str) -> "Primary":
        ...
        self.speed_limit_1 = convert_speed(extract_field(line, w_pri.speed_limit_1))
        ...
        self.speed_limit_2 = convert_speed(extract_field(line, w_pri.speed_limit_2))
    ...
    def to_dict(self) -> dict:
        ...
        this_dict = {
            ...
            "speed_limit_1": clean_value(self.speed_limit_1),
