...
class Primary(Base):
    ...
    def __init__(self):
        super().__init__("heli_terminal_comms")
    ...
    def to_dict(self) -> dict:
        ...
        this_dict = {
            ...
            "sector_sec_code": clean_value(self.sector_sec_code),
            "sector_sub_code": clean_value(self.sector_sub_code),
            "dist_desc": clean_value(self.dist_desc),
            "comm_dist": clean_value(self.comm_dist),
